...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yk.2o8.cc"];
pub const PUBLIC_RS_PUB_KEY: &str = "xpMHlImf+nIVTGuQv03FoeJYURTtV6nSGmziVWMS7FR8nfGdS6gBbNTcbi94Ojszhe2rys3zSFCfn4PH4ZUnwg==";
